...
# Foundation.
Summary:     Fortishield indexer is a search and analytics engine for security-related data. Documentation can be found at https://documentation.fortishield.github.io/current/getting-started/components/fortishield-indexer.html
