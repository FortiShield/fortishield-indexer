...
# Foundation.
Summary:     Fortishield indexer is a search and analytics engine for security-related data. Documentation can be found at https://documentation.fortishield.com/current/getting-started/components/fortishield-indexer.html
...
URL:         https://www.fortishield.com/
BuildRoot:   %{_tmppath}/%{name}-%{version}-%{release}-root-%(%{__id_u} -n)
Vendor:      Fortishield, Inc <info@fortishield.com>
Packager:    Fortishield, Inc <info@fortishield.com>
AutoReqProv: no
Requires: coreutils
ExclusiveOS: linux
...
%global INDEXER_FILE fortishield-indexer-base-%{version}-%{release}-linux-x64.tar.xz

# -----------------------------------------------------------------------------

%description
Fortishield indexer is a near real-time full-text search and analytics engine that gathers security-related data into one platform. This Fortishield central component indexes and stores alerts generated by the Fortishield server. Fortishield indexer can be configured as a single-node or multi-node cluster, providing scalability and high availability. Documentation can be found at https://documentation.fortishield.com/current/getting-started/components/fortishield-indexer.html
...
chown -R %{USER}:%{GROUP} fortishield-indexer-*/*

# Copy base files into RPM_BUILD_ROOT directory
mv fortishield-indexer-*/etc ${RPM_BUILD_ROOT}/
mv fortishield-indexer-*%{SYS_DIR}/* ${RPM_BUILD_ROOT}%{SYS_DIR}/
rm -rf fortishield-indexer-*/etc
rm -rf fortishield-indexer-*/usr
cp -pr fortishield-indexer-*/* ${RPM_BUILD_ROOT}%{INSTALL_DIR}/

# Build fortishield-certs-tool
%{REPO_DIR}/builder.sh -c

# Build fortishield-passwords-tool
%{REPO_DIR}/builder.sh -p

# Copy the security tools
cp %{REPO_DIR}/fortishield-certs-tool.sh ${RPM_BUILD_ROOT}%{INSTALL_DIR}/plugins/opensearch-security/tools/
cp %{REPO_DIR}/fortishield-passwords-tool.sh ${RPM_BUILD_ROOT}%{INSTALL_DIR}/plugins/opensearch-security/tools/
cp /root/documentation-templates/fortishield/config.yml ${RPM_BUILD_ROOT}%{INSTALL_DIR}/plugins/opensearch-security/tools/config.yml

# Copy Fortishield's config files for the security plugin
...
chmod 750 ${RPM_BUILD_ROOT}/etc/init.d/fortishield-indexer
...
if [ $1 = 1 ];then # Install
    ...
    # To pick up /usr/lib/sysctl.d/fortishield-indexer.conf
...
if [ -f %{INSTALL_DIR}/%{name}.restart ]; then
    echo -n "Starting fortishield-indexer service..."
...
%attr(740, %{USER}, %{GROUP}) %{INSTALL_DIR}/plugins/opensearch-security/tools/fortishield-certs-tool.sh
%attr(740, %{USER}, %{GROUP}) %{INSTALL_DIR}/plugins/opensearch-security/tools/fortishield-passwords-tool.sh


%changelog
* Thu Mar 28 2024 support <info@fortishield.com> - 4.9.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-9-0.html
* Tue Jan 30 2024 support <info@fortishield.com> - 4.8.1
- More info: https://documentation.fortishield.com/current/release-notes/release-4-8-1.html
* Fri Dec 15 2023 support <info@fortishield.com> - 4.8.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-8-0.html
* Tue Dec 05 2023 support <info@fortishield.com> - 4.7.1
- More info: https://documentation.fortishield.com/current/release-notes/release-4-7-1.html
* Tue Nov 21 2023 support <info@fortishield.com> - 4.7.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-7-0.html
* Tue Oct 31 2023 support <info@fortishield.com> - 4.6.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-6-0.html
* Tue Oct 24 2023 support <info@fortishield.com> - 4.5.4
- More info: https://documentation.fortishield.com/current/release-notes/release-4-5-4.html
* Tue Oct 10 2023 support <info@fortishield.com> - 4.5.3
- More info: https://documentation.fortishield.com/current/release-notes/release-4-5-3.html
* Thu Aug 31 2023 support <info@fortishield.com> - 4.5.2
- More info: https://documentation.fortishield.com/current/release-notes/release-4-5-2.html
* Thu Aug 24 2023 support <info@fortishield.com> - 4.5.1
- More info: https://documentation.fortishield.com/current/release-notes/release-4-5.1.html
* Thu Aug 10 2023 support <info@fortishield.com> - 4.5.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-5-0.html
* Mon Jul 10 2023 support <info@fortishield.com> - 4.4.5
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-5.html
* Tue Jun 13 2023 support <info@fortishield.com> - 4.4.4
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-4.html
* Thu May 25 2023 support <info@fortishield.com> - 4.4.3
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-3.html
* Mon May 08 2023 support <info@fortishield.com> - 4.4.2
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-2.html
* Mon Apr 17 2023 support <info@fortishield.com> - 4.4.1
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-1.html
* Wed Jan 18 2023 support <info@fortishield.com> - 4.4.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-4-0.html
* Thu Nov 10 2022 support <info@fortishield.com> - 4.3.10
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-10.html
* Mon Oct 03 2022 support <info@fortishield.com> - 4.3.9
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-9.html
* Mon Sep 19 2022 support <info@fortishield.com> - 4.3.8
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-8.html
* Mon Aug 08 2022 support <info@fortishield.com> - 4.3.7
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-7.html
* Thu Jul 07 2022 support <info@fortishield.com> - 4.3.6
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-6.html
* Wed Jun 29 2022 support <info@fortishield.com> - 4.3.5
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-5.html
* Tue Jun 07 2022 support <info@fortishield.com> - 4.3.4
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-4.html
* Tue May 31 2022 support <info@fortishield.com> - 4.3.3
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-3.html
* Mon May 30 2022 support <info@fortishield.com> - 4.3.2
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-2.html
* Wed May 18 2022 support <info@fortishield.com> - 4.3.1
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-1.html
* Thu May 05 2022 support <info@fortishield.com> - 4.3.0
- More info: https://documentation.fortishield.com/current/release-notes/release-4-3-0.html
