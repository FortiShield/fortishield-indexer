...
# Events generator tool for Fortishield's indices.
...
#  -i: index name prefix or module (e.g: fortishield-alerts, fortishield-states-vulnerabilities)
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Events generator tool for Fortishield's indices. Indexes a random element from <index>/alerts.json",
    )
    parser.add_argument(
        '-o', '--output',
    ...
    parser.add_argument(
        ...
        help="Index name or module (e.g: fortishield-alerts, fortishield-states-vulnerabilities)"
    )
